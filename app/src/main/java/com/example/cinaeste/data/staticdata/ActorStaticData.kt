...
import com.example.cinaeste.data.models.Actor
import com.example.cinaeste.data.models.Movie

fun actors() : List<Actor> {
    return listOf(
        Actor("Meho Mehic", listOf(
